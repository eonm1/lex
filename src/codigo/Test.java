...
public class Test extends AnalizadorLexico{
    ...
    public Test() {
        ...
        AutoSuggestor autoSuggestor = new AutoSuggestor(f, frame, words, Color.WHITE.brighter(), Color.BLUE, Color.RED, 0.90f) {
            @Override
...
class AutoSuggestor {
    ...
    private void showPopUpWindow() {
        ...
        if (textComp instanceof JTextField) {//calculate x and y for JWindow at bottom of JTextField
            ...
            windowX = (int) (rect.getX() + 280);
            windowY = (int) (rect.getY() + (rect.getHeight()*10));
        }
